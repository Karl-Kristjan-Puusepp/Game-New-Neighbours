...
public class Game : MonoBehaviour
{
    ...
    private async void EndGame()
    {
        ...
        else if (happinessPercentage >= 50) gameEndString += "The townsfolk are pleased with their new residences.";
        else if (happinessPercentage >= 25) gameEndString += "The townsfolk are disappointed.";
        else gameEndString += "You should be ashamed.";
        GameEndText.text = gameEndString;

        await(Task.Delay(300)); //MenuPanel doesn't open without this
